...
import com.example.day5cw2.service.BasaEmployeeService;
...
public class BasaEmployeeController {
    ...
    public ResponseEntity<BasaEmployee> putMethodName(@PathVariable("employeeId") int id, @RequestBody BasaEmployee employee) {
    ...
    public ResponseEntity<BasaEmployee> delete(@PathVariable("employeeId") int id,@RequestBody BasaEmployee employee)
    {
