...
import com.example.day5cw1.service.BasaProductService;
...
public class BasaProductController {
    ...
    public ResponseEntity<Basamodel> postMethodName(@RequestBody Basamodel product) {
    ...
    public ResponseEntity<Basamodel> putMethodName(@PathVariable("productId") int id, @RequestBody Basamodel product) {
    ...
    public ResponseEntity<Basamodel> delete(@PathVariable("productId") int id,@RequestBody Basamodel product)
    {
